...
<html>
    <head>
        ...
        <!--end slider -->
        <!--script-->
        <script type="text/javascript" src="{{asset('public/front_end_asset/js/move-top.js')}}"></script>
        <script type="text/javascript" src="{{asset('public/front_end_asset/js/easing.js')}}"></script>
        <!--/script-->
